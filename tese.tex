...
\input{conteudo2/resumoabstract}
...
\begin{tabular}{rl}
  ...
  $\mathds{1}^{\text{obj}}_i$ & Função indicadora que vale 1 se a grid cell $i$ contém o centro de um objeto, 0 caso contrário\\
  $\mathds{1}^{\text{no obj}}_i$ & Função indicadora que vale 1 se a grid cell $i$ não contém o centro de um objeto, 0 caso contrário\\
\end{tabular}
...
\input{conteudo2/introducao}
\pagestyle{mainmatter}
\input{conteudo2/descricao}
\input{conteudo2/ml_projeto}
\input{conteudo2/detalhes}
\input{conteudo2/proximos}
\input{conteudo2/conclusao}
